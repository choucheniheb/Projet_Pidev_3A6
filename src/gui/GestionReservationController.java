...
//        myLabel.setText(myPrix);
    ...
    private void AjouterReservation(ActionEvent event) {
        try {
            Reservation r = new Reservation(date_res_picker.getValue().toString(), Double.parseDouble(prix_res.getValue()), 1, TestFX.getId_user(), 25);
            ps1.ajouter(r);
            System.out.println(ps1.recuperer());
            SMSSender ss = new SMSSender();
            ss.SMSSENDER(TestFX.getId_user());
            update();
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
        }
    ...
    private void createpdf(ActionEvent event) throws SQLException {
       ...
       PdfWriter.getInstance(doc,new FileOutputStream("C:\\Users\\msi\\Documents\\NetBeansProjects\\FinalPiDev\\src\\gui\\image\\pdf.pdf"));
       doc.open();
       
      Image img = Image.getInstance("C:\\Users\\msi\\Documents\\NetBeansProjects\\FinalPiDev\\src\\gui\\image\\324352899_1367577970682741_241313171972203892_n.png");
     ...
     img.setAlignment(Image.ALIGN_CENTER);
      doc.add(img);
       ...
       doc.close();
       Desktop.getDesktop().open(new File("C:\\Users\\msi\\Documents\\NetBeansProjects\\FinalPiDev\\src\\gui\\image\\pdf.pdf"));
