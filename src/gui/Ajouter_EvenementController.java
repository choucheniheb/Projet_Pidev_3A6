        ...
        Ajouter_Evenement.setOnAction(e -> {
            ...
            if (descriptionText.contains("shit") || descriptionText.contains("fuck") || descriptionText.contains("test")) {
                ...
                try {
                    ...
                    evenements ev = new evenements(titre.getText(), type.getText(), date.getValue().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")), lieux.getText(), Double.parseDouble(prix.getText()), inv, description.getText(), TestFX.getId_user(), path);
...
//            PublicationCrud test = new PublicationCrud() ;
    ...
    @FXML
    private void swProfileUser(javafx.scene.input.MouseEvent event) {
    }
