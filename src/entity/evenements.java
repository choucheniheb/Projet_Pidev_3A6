...
public class evenements {
    ...
    public evenements(String titre_evenement, String type_evenement, String lieux_evenement, Double prix_evenement, invites id_invite, String description_evenement, int id_utilisateur) {
    ...
    public evenements(int id_evenement, String titre_evenement, String type_evenement, String date_evenement, String lieux_evenement, Double prix_evenement, invites id_invite, String description_evenement, int id_utilisateur) {
    ...
    public evenements(String titre_evenement, String type_evenement, String date_evenement, String lieux_evenement, Double prix_evenement, invites id_invite, String description_evenement, int id_utilisateur) {
        this.titre_evenement = titre_evenement;
        this.type_evenement = type_evenement;
        this.date_evenement = date_evenement;
        this.lieux_evenement = lieux_evenement;
    ...
    public evenements(String titre_evenement, String type_evenement, String date_evenement, String lieux_evenement, Double prix_evenement, invites id_invite, String description_evenement, int id_utilisateur,String image) {
        this.titre_evenement = titre_evenement;
        this.type_evenement = type_evenement;
        this.date_evenement = date_evenement;
        this.lieux_evenement = lieux_evenement;
