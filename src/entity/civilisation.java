...
public class civilisation {
 ...
 public civilisation(String nom_civilisation, String nom_monument, String description_civilisation, String date_debut_civilisation, String date_fin_civilisation, int id_utilisateur,String image) {
        this.nom_civilisation = nom_civilisation;
        this.nom_monument = nom_monument;
        this.description_civilisation = description_civilisation;
        this.date_debut_civilisation = date_debut_civilisation;
    ...
    public String toString() {
        return "civilisation{" + "id_civilisation=" + id_civilisation + ", id_utilisateur=" + id_utilisateur + ", nom_civilisation=" + nom_civilisation + ", nom_monument=" + nom_monument + ", description_civilisation=" + description_civilisation + ", date_debut_civilisation=" + date_debut_civilisation + ", date_fin_civilisation=" + date_fin_civilisation + ", image=" + image + '}';
    }
